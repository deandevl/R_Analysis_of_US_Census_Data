...
born_in_mexico_5_dt <- RcensusPkg::get_vintage_data(
  dataset = "acs/acs5",
  vintage = 2020,
  vars = list(estimate = c("B05006_150E"), moe = c("B05006_150M")),
  region = "state"
) %>% data.table::setorder(NAME)
```
...
acs5_cbsa_dt <- RcensusPkg::get_vintage_data(
  dataset = "acs/acs5",
  vintage = 2020,
  vars = list(estimate = c("B01003_001E"), moe = c("B01003_001M")),
...
wi_income_dt <- RcensusPkg::get_vintage_data(
  dataset = "acs/acs5",
  vintage = 2020,
  vars = list(estimate = c("B19013_001E"), moe = c("B19013_001M")),
  region = "county:*",
